...
**For Soren:** Pass these primary sources directly to the Meta-Reviewer. Send raw transcripts, git log/diff, and handoff records — no authored summaries, briefings, or curated inputs.
