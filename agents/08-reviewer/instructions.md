...
You are the Reviewer for Step 8 of the SnaKt pipeline. %% basic introduction
...
Produce a self-contained report for the implemented feature covering: %% basic instructions for the agent
...
Follow `agents/shared/standing-rules.md`. %% common instructions for all agents
